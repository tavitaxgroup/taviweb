# Prompt Studio AI Fine Dining Restaurant - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page nhà hàng sang trọng thành code Next.js.

```txt
Hãy chuyển thiết kế landing page nhà hàng sang trọng này thành code Next.js.
...
7. Template component cần tạo là FineDiningRestaurantTemplate.
8. Template key là fine-dining-restaurant.
9. Ngành là nhà hàng sang trọng.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành nhà hàng sang trọng.
...
Template cần tạo:
- template_key: fine-dining-restaurant
- template component: FineDiningRestaurantTemplate
...
6. DemoTemplateRenderer render FineDiningRestaurantTemplate.
...
Ví dụ sai:
<h1>Nhà Hàng La Maison</h1>
<img src="/fine-dining.jpg" />
<a href="tel:0901234567">Đặt bàn ngay</a>
...
- Không hard-code menu, giá món, giờ mở cửa, đầu bếp, giải thưởng hoặc số lượng bàn nếu không có dữ liệu.
- Không dùng ảnh món ăn fallback như món thật của nhà hàng.
...
Template này render website demo public cho nhà hàng sang trọng tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template sang trọng, giàu hình ảnh, gợi trải nghiệm ẩm thực, tối ưu CTA đặt bàn hoặc gọi nhà hàng.
FineDiningRestaurantTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên nhà hàng, phone, ảnh, menu, giá món, giờ mở cửa, đầu bếp hoặc giải thưởng.
Mobile-first; trên mobile ưu tiên ảnh đẹp, nút đặt bàn/gọi và xem bản đồ.
Desktop dùng layout sang, thoáng, nhiều không gian cho ảnh món ăn và không gian nhà hàng.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback restaurant/fine dining an toàn.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp nhà hàng sang trọng:
- Dùng bữa tại nhà hàng.
- Đặt bàn nhóm.
- Tiệc riêng hoặc sự kiện nhỏ.
- Thực đơn đặc trưng.
- Trải nghiệm không gian ẩm thực.

Visual direction:
- Cảm giác tinh tế, ấm, sang, đáng đặt bàn.
- Màu chính: burgundy, deep red, charcoal hoặc warm dark.
- Accent: muted gold, olive hoặc champagne.
- Background: warm white hoặc tone tối có contrast tốt.
- Hình ảnh: món ăn, bàn tiệc, không gian nhà hàng, quầy bar, ánh sáng ấm.
- Tránh ảnh quá tối khiến CTA khó đọc.
- Tránh bịa món signature hoặc menu cụ thể.

CTA direction:
- CTA chính: Đặt bàn ngay.
- CTA phụ: Gọi nhà hàng hoặc Xem bản đồ.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành nhà hàng sang trọng.
