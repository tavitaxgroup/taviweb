# Prompt Studio AI Cleaning Service - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page dịch vụ vệ sinh công nghiệp thành code Next.js.

```txt
Hãy chuyển thiết kế landing page dịch vụ vệ sinh công nghiệp này thành code Next.js.
...
7. Template component cần tạo là CleaningServiceTemplate.
8. Template key là cleaning-service.
9. Ngành là dịch vụ vệ sinh công nghiệp.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành dịch vụ vệ sinh công nghiệp.
...
Template cần tạo:
- template_key: cleaning-service
- template component: CleaningServiceTemplate
...
6. DemoTemplateRenderer render CleaningServiceTemplate.
...
Ví dụ sai:
<h1>Công Ty Vệ Sinh Sạch Nhanh</h1>
<img src="/cleaning-service.jpg" />
<a href="tel:0901234567">Gọi báo giá</a>
...
- Không hard-code bảng giá, cam kết thời gian hoặc khu vực phục vụ nếu không có dữ liệu.
...
Template này render website demo public cho dịch vụ vệ sinh công nghiệp tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template sạch, rõ, thực dụng, đáng tin, tối ưu CTA gọi báo giá.
CleaningServiceTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên công ty, phone, ảnh, bảng giá, cam kết thời gian hoặc khu vực phục vụ.
Mobile-first; trên mobile ưu tiên nút gọi báo giá và xem khu vực/dia chỉ.
Desktop dùng layout rõ ràng, service cards dễ scan, trust badges nổi bật.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback vệ sinh/xử lý không gian sạch.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp cleaning service:
- Vệ sinh văn phòng.
- Tổng vệ sinh nhà ở.
- Vệ sinh công trình sau xây dựng.
- Vệ sinh kính.
- Giặt thảm, sofa hoặc nệm.

Visual direction:
- Cảm giác sạch, nhanh, đúng hẹn, chuyên nghiệp.
- Màu chính: green hoặc blue clean.
- Accent: cyan hoặc bright green nhẹ.
- Hình ảnh: đội ngũ vệ sinh, thiết bị, không gian sạch, văn phòng/sàn/kính sau khi vệ sinh.
- Tránh thiết kế quá mềm như spa.
- Tránh ảnh before-after giả hoặc ảnh bẩn quá mức gây khó chịu.

CTA direction:
- CTA chính: Gọi báo giá.
- CTA phụ: Nhắn tư vấn hoặc Xem khu vực phục vụ.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành dịch vụ vệ sinh công nghiệp.
