# Prompt Studio AI Hair Salon - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page hair salon / tiệm làm tóc thành code Next.js.

```txt
Hãy chuyển thiết kế landing page hair salon / tiệm làm tóc này thành code Next.js.
...
7. Template component cần tạo là HairSalonTemplate.
8. Template key là hair-salon.
9. Ngành là hair salon / tiệm làm tóc.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành hair salon / tiệm làm tóc.
...
Template cần tạo:
- template_key: hair-salon
- template component: HairSalonTemplate
...
6. DemoTemplateRenderer render HairSalonTemplate.
...
Ví dụ sai:
<h1>Salon Tóc Minh Anh</h1>
<img src="/hair-salon.jpg" />
<a href="tel:0901234567">Đặt lịch làm tóc</a>
...
- Không hard-code bảng giá, stylist cụ thể, combo dịch vụ, màu nhuộm hoặc cam kết kết quả nếu không có dữ liệu.
- Không dùng ảnh before-after giả nếu không có dữ liệu thật.
...
Template này render website demo public cho hair salon / tiệm làm tóc tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template thời trang, có cá tính, hiện đại, giàu hình ảnh, tối ưu CTA đặt lịch làm tóc hoặc nhắn Facebook.
HairSalonTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên salon, phone, ảnh, stylist, bảng giá, combo, màu nhuộm hoặc cam kết kết quả.
Mobile-first; trên mobile ưu tiên CTA đặt lịch, nhắn Facebook, gọi salon và xem địa chỉ.
Desktop dùng layout có cá tính, gallery nổi bật, service cards dễ scan.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback salon/tóc an toàn, không dùng before-after giả.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp hair salon:
- Cắt tạo kiểu.
- Nhuộm tóc.
- Uốn/Duỗi.
- Phục hồi tóc.
...
Visual direction:
- Cảm giác phong cách, tự tin, sáng tạo, gần gũi.
- Màu chính: charcoal, black, warm neutral hoặc cream.
- Accent: peach, copper, rose gold hoặc caramel.
- Hình ảnh: kiểu tóc, ghế salon, gương, khu gội, stylist, không gian salon.
- Tránh ảnh stock quá lộ hoặc ảnh before-after giả.
- Tránh layout quá high-fashion khó code hoặc làm CTA bị chìm.

CTA direction:
- CTA chính: Đặt lịch làm tóc.
- CTA phụ: Nhắn Facebook hoặc Gọi salon.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành hair salon / tiệm làm tóc.
