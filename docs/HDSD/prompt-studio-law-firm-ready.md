# Prompt Studio AI Law Firm - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page văn phòng luật sư thành code Next.js.

```txt
Hãy chuyển thiết kế landing page văn phòng luật sư này thành code Next.js.
...
7. Template component cần tạo là LawFirmTemplate.
8. Template key là law-firm.
9. Ngành là văn phòng luật sư.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành văn phòng luật sư.
...
Template cần tạo:
- template_key: law-firm
- template component: LawFirmTemplate
...
6. DemoTemplateRenderer render LawFirmTemplate.
...
Ví dụ sai:
<h1>Văn Phòng Luật Sư Minh Tâm</h1>
...
- Không hard-code luật sư cụ thể, chứng chỉ, số vụ thắng kiện, khách hàng tiêu biểu, phí tư vấn hoặc cam kết kết quả pháp lý nếu không có dữ liệu.
- Không hứa thắng kiện, giải quyết chắc chắn hoặc dùng ngôn ngữ gây sợ hãi.
...
Template này render website demo public cho văn phòng luật sư tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template nghiêm túc, tin cậy, bảo mật, chuyên nghiệp, tối ưu CTA đặt lịch tư vấn hoặc gọi văn phòng.
LawFirmTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên văn phòng, phone, ảnh, luật sư cụ thể, chứng chỉ, số vụ thắng kiện, phí tư vấn hoặc cam kết kết quả pháp lý.
Mobile-first; trên mobile ưu tiên CTA đặt lịch tư vấn, gọi văn phòng, gửi email và xem địa chỉ.
Desktop dùng layout trang nhã, nhiều khoảng trắng, typography rõ, cảm giác đáng tin.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback văn phòng/pháp lý an toàn, không claim là ảnh thật của doanh nghiệp.
Thiếu phone dùng email/Facebook/map.

Service mặc định nên phù hợp văn phòng luật:
- Tư vấn doanh nghiệp.
- Hợp đồng.
- Tranh chấp dân sự.
- Lao động.
...
Visual direction:
- Cảm giác tin cậy, nghiêm túc, bảo mật, rõ ràng.
- Màu chính: navy, charcoal, slate hoặc deep blue.
- Accent: muted gold, bronze hoặc warm gray.
- Hình ảnh: văn phòng, phòng họp, tài liệu, sách luật, bàn tư vấn.
- Tránh hình ảnh tòa án quá kịch tính hoặc gây sợ hãi.
- Tránh màu sắc quá rực, quá vui hoặc giống giáo dục/F&B.

CTA direction:
- CTA chính: Đặt lịch tư vấn.
- CTA phụ: Gọi văn phòng hoặc Gửi email.
- Nếu thiếu số điện thoại, không render nút gọi; dùng email/map/Facebook.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành văn phòng luật sư.
