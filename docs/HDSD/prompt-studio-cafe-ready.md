# Prompt Studio AI Cafe - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page quán cafe thành code Next.js.

```txt
Hãy chuyển thiết kế landing page quán cafe này thành code Next.js.
...
7. Template component cần tạo là CafeTemplate.
8. Template key là cafe.
9. Ngành là quán cafe.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành quán cafe.
...
Template cần tạo:
- template_key: cafe
- template component: CafeTemplate
...
6. DemoTemplateRenderer render CafeTemplate.
...
- Không hard-code menu, giá, giờ mở cửa nếu không có dữ liệu.
...
Template này render website demo public cho quán cafe tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template ấm áp, có gu, giàu hình ảnh, tối ưu CTA xem đường đi.
CafeTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên quán, phone, ảnh, menu, giá hoặc giờ mở cửa.
Mobile-first; trên mobile ưu tiên ảnh, nút xem đường đi và CTA liên hệ.
Desktop dùng layout thoáng, nhiều không gian cho ảnh quán và gallery.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback cafe an toàn.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp cafe:
- Cà phê và đồ uống.
- Không gian gặp gỡ.
- Góc check-in.
- Take-away.
- Sự kiện nhỏ hoặc nhóm bạn.

Visual direction:
- Cảm giác ấm áp, gần gũi, có gu, đáng ghé.
- Màu chính: coffee brown, cream, warm white.
- Accent: green hoặc caramel nhẹ.
- Hình ảnh: ly cà phê, góc ngồi, mặt tiền, quầy pha chế, ánh sáng tự nhiên.
- Tránh ảnh stock quá lộ, màu nền quá tối làm giảm khả năng đọc.

CTA direction:
- CTA chính: Xem đường đi.
- CTA phụ: Gọi quán hoặc Nhắn Facebook.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành quán cafe.
