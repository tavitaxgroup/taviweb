# Prompt Studio AI Wedding Studio - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page studio chụp ảnh cưới thành code Next.js.

```txt
Hãy chuyển thiết kế landing page studio chụp ảnh cưới này thành code Next.js.
...
7. Template component cần tạo là WeddingStudioTemplate.
8. Template key là wedding-studio.
9. Ngành là studio chụp ảnh cưới.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành studio chụp ảnh cưới.
...
Template cần tạo:
- template_key: wedding-studio
- template component: WeddingStudioTemplate
...
6. DemoTemplateRenderer render WeddingStudioTemplate.
...
Ví dụ sai:
<h1>Studio Cưới Minh Anh</h1>
<img src="/wedding-studio.jpg" />
<a href="tel:0901234567">Đặt lịch tư vấn</a>
...
- Không hard-code bảng giá, package chụp, tên cặp đôi, ngày cưới, địa điểm chụp hoặc cam kết sản phẩm nếu không có dữ liệu.
- Không dùng ảnh cặp đôi riêng tư, ảnh cưới thật hoặc before-after nếu không có quyền/dữ liệu xác nhận.
...
Template này render website demo public cho studio chụp ảnh cưới tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template lãng mạn, tinh tế, giàu hình ảnh, premium nhưng dễ code, tối ưu CTA đặt lịch tư vấn hoặc nhắn Facebook.
WeddingStudioTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên studio, phone, ảnh, package giá, tên cặp đôi, album thật, ngày cưới hoặc cam kết sản phẩm.
Mobile-first; trên mobile ưu tiên ảnh lớn, CTA tư vấn, nhắn Facebook, gọi studio và xem địa chỉ.
Desktop dùng layout image-first, gallery rộng, typography mềm và sang.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback wedding/studio an toàn, không claim là portfolio thật.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp studio ảnh cưới:
- Chụp ảnh cưới.
- Tư vấn concept.
- Trang phục cưới.
- Makeup cô dâu.
- Album cưới.
- Chụp pre-wedding hoặc indoor/outdoor.

Visual direction:
- Cảm giác lãng mạn, tinh tế, đáng nhớ, chuyên nghiệp.
- Màu chính: mauve, blush, champagne, ivory hoặc warm white.
- Accent: rose gold, muted gold hoặc dusty pink.
- Hình ảnh: studio, váy cưới, bó hoa, máy ảnh, không gian chụp, chi tiết album.
- Tránh dùng ảnh cặp đôi riêng tư nếu không có quyền.
- Tránh layout quá nhiều hiệu ứng khiến gallery khó xem hoặc CTA bị chìm.

CTA direction:
- CTA chính: Đặt lịch tư vấn.
- CTA phụ: Nhắn Facebook hoặc Gọi studio.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành studio chụp ảnh cưới.
