# Prompt Studio AI Spa - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page spa thẩm mỹ thành code Next.js.

```txt
Hãy chuyển thiết kế landing page spa thẩm mỹ này thành code Next.js.
...
7. Template component cần tạo là SpaTemplate.
8. Template key là spa.
9. Ngành là spa thẩm mỹ.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành spa thẩm mỹ.
...
Template cần tạo:
- template_key: spa
- template component: SpaTemplate
...
6. DemoTemplateRenderer render SpaTemplate.
...
<h1>Lavender Spa</h1>
<img src="/spa.jpg" />
<a href="tel:0901234567">Đặt lịch chăm sóc</a>
...
- Không hard-code bảng giá, gói liệu trình, chuyên viên cụ thể, cam kết làm đẹp hoặc kết quả điều trị nếu không có dữ liệu.
- Không dùng ảnh cơ thể nhạy cảm hoặc before-after giả nếu không có dữ liệu thật.
...
Template này render website demo public cho spa thẩm mỹ tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template thư giãn, mềm mại, tinh tế, premium nhưng dễ code, tối ưu CTA đặt lịch chăm sóc hoặc nhắn tư vấn.
SpaTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên spa, phone, ảnh, bảng giá, gói liệu trình, chuyên viên, cam kết hiệu quả hoặc kết quả làm đẹp.
Mobile-first; trên mobile ưu tiên CTA đặt lịch, nhắn Facebook, gọi spa và xem địa chỉ.
Desktop dùng layout thoáng, nhẹ, nhiều khoảng trắng, hình ảnh không gian spa nổi bật.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback spa/chăm sóc da an toàn, không dùng ảnh nhạy cảm.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp spa:
- Chăm sóc da mặt.
- Massage thư giãn.
- Trị liệu body.
- Gội đầu dưỡng sinh.
...
Visual direction:
- Cảm giác thư giãn, chăm sóc cá nhân, mềm mại, tinh tế.
- Màu chính: rose, blush, champagne, ivory hoặc sage.
- Accent: soft gold, warm beige, muted green hoặc dusty pink.
- Hình ảnh: phòng spa, giường trị liệu, khăn, tinh dầu, sản phẩm chăm sóc, không gian lễ tân.
- Tránh màu neon, layout quá y khoa hoặc hình ảnh cơ thể nhạy cảm.
- Tránh claim hiệu quả làm đẹp tuyệt đối.

CTA direction:
- CTA chính: Đặt lịch chăm sóc.
- CTA phụ: Nhắn Facebook hoặc Gọi tư vấn.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành spa thẩm mỹ.
