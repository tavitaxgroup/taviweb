# Prompt Studio AI Construction Company - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page công ty xây dựng thành code Next.js.

```txt
Hãy chuyển thiết kế landing page công ty xây dựng này thành code Next.js.
...
7. Template component cần tạo là ConstructionCompanyTemplate.
8. Template key là construction-company.
9. Ngành là công ty xây dựng.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành công ty xây dựng.
...
Template cần tạo:
- template_key: construction-company
- template component: ConstructionCompanyTemplate
...
6. DemoTemplateRenderer render ConstructionCompanyTemplate.
...
Ví dụ sai:
<h1>Công Ty Xây Dựng Minh Long</h1>
<img src="/construction.jpg" />
<a href="tel:0901234567">Gọi tư vấn công trình</a>
...
- Không hard-code bảng giá, tiến độ, diện tích, số dự án hoặc cam kết xây dựng nếu không có dữ liệu.
- Không dùng ảnh công trình như dự án thật nếu đó chỉ là ảnh fallback.
...
Template này render website demo public cho công ty xây dựng tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template chắc chắn, chuyên nghiệp, đáng tin, tối ưu CTA gọi tư vấn công trình hoặc nhận báo giá.
ConstructionCompanyTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên công ty, phone, ảnh, bảng giá, số dự án, cam kết tiến độ hoặc thông tin công trình.
Mobile-first; trên mobile ưu tiên CTA gọi tư vấn và xem địa chỉ/khu vực hoạt động.
Desktop dùng layout vững chắc, grid rõ, có cảm giác kỹ thuật và năng lực thi công.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback công trình/xây dựng an toàn.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp công ty xây dựng:
- Xây nhà trọn gói.
- Sửa chữa cải tạo.
- Thi công phần thô.
- Hoàn thiện nội thất.
...
Visual direction:
- Cảm giác vững chắc, minh bạch, đúng quy trình, đáng tin.
- Màu chính: slate, graphite hoặc navy kỹ thuật.
- Accent: amber/cam xây dựng hoặc concrete gray.
- Hình ảnh: công trình, bản vẽ, đội thi công, vật liệu, chi tiết hoàn thiện.
- Tránh thiết kế quá mềm hoặc quá luxury như bất động sản cao cấp nếu không phù hợp.
- Tránh claim ảnh fallback là dự án thực tế.

CTA direction:
- CTA chính: Gọi tư vấn công trình.
- CTA phụ: Nhận báo giá hoặc Xem địa chỉ.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành công ty xây dựng.
