# Prompt Studio AI General Clinic - Dùng Ngay

Copy toàn bộ prompt này vào Studio AI khi muốn chuyển thiết kế landing page phòng khám đa khoa thành code Next.js.

```txt
Hãy chuyển thiết kế landing page phòng khám đa khoa này thành code Next.js.
...
7. Template component cần tạo là GeneralClinicTemplate.
8. Template key là general-clinic.
9. Ngành là phòng khám đa khoa.
...
Mục tiêu:
Tạo một website template public cho doanh nghiệp thuộc ngành phòng khám đa khoa.
...
Template cần tạo:
- template_key: general-clinic
- template component: GeneralClinicTemplate
...
6. DemoTemplateRenderer render GeneralClinicTemplate.
...
Ví dụ sai:
<h1>Phòng Khám Đa Khoa Minh Tâm</h1>
<img src="/general-clinic.jpg" />
<a href="tel:0901234567">Gọi phòng khám</a>
...
- Không dùng ảnh bệnh lý, ảnh điều trị nhạy cảm hoặc claim y tế quá mức.
- Không hard-code bác sĩ, chuyên khoa, chứng chỉ, bảng giá, giờ khám hoặc cam kết điều trị nếu không có dữ liệu.
...
Template này render website demo public cho phòng khám đa khoa tại /demo/[place_id]. Hiện tại dùng mock data để preview, sau này thay bằng Supabase fetch.
Code template y tế hiện đại, rõ ràng, an toàn, đáng tin, tối ưu CTA gọi phòng khám hoặc đặt lịch tư vấn.
GeneralClinicTemplate dùng 10 section chuẩn: Navbar, Hero, Trust, About, Services, Gallery, Why Choose Us, Reviews, Contact CTA, Footer.
Bind business, hero, trust, about, services, gallery, reviews, contact, seo.
Không hard-code tên phòng khám, phone, ảnh, bác sĩ, chuyên khoa, bảng giá, chứng chỉ hoặc cam kết điều trị.
Mobile-first; trên mobile ưu tiên CTA gọi phòng khám, xem bản đồ và thông tin liên hệ.
Desktop dùng layout sạch, nhiều khoảng trắng, trust metrics rõ, thông tin dễ scan.
Không dùng video background; gallery lazy load.
Thiếu ảnh dùng fallback clinic/phòng khám sạch, sáng, không gây khó chịu.
Thiếu phone dùng Facebook/map/email.

Service mặc định nên phù hợp phòng khám đa khoa:
- Khám tổng quát.
- Khám chuyên khoa.
- Xét nghiệm cơ bản.
...
Visual direction:
- Cảm giác an toàn, sạch sẽ, chuyên môn, thân thiện với gia đình.
- Màu chính: blue medical, cyan, green hoặc white clean.
- Accent: soft green hoặc sky blue.
- Hình ảnh: phòng khám, quầy tiếp nhận, phòng chờ, thiết bị y tế, đội ngũ.
- Tránh ảnh bệnh lý, phẫu thuật, máu hoặc hình ảnh gây lo lắng.
- Tránh thiết kế quá beauty như spa hoặc quá lạnh như bệnh viện lớn.

CTA direction:
- CTA chính: Gọi phòng khám hoặc Đặt lịch tư vấn.
...
Kết quả mong muốn:
Tạo một Next.js public website template cho ngành phòng khám đa khoa.
